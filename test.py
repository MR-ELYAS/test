...
lll = ("https://b-api.facebook.com/method/POST")
#----[remover]-----
try:
...
logo= f'''
\033[1;32md88888b db   dD d888888b d8b   db  d888b  
\033[1;35m88'     88 ,8P'   `88'   888o  88 88' Y8b \033[1;34mP
\033[1;32m88ooooo 88,8P      88    88V8o 88 88      \033[1;91mR
\033[1;35m88~~~~~ 88`8b      88    88 V8o88 88  ooo O
\033[1;32m88.     88 `88.   .88.   88  V888 88. ~8~ 
...
update = requests.get('https://raw.githubusercontent.com/MR-ELYAS/test/main/key.txt').text
...
bxd = ""
bumper = id+bxd+xp
myweb2 = requests.get('https://raw.githubusercontent.com/MR-ELYAS/test/main/key.txt').text
...
def qsbuy():
	try:
		...
		try:
			...
			print(50*"-")
			print(f" Note : THIS TOOLS IS PAID SO YOU NEED TO PAY THIS TOOL ")
			print("\n This Tools Rate ")
			print(50*"-")
			print(f" 15-Days Price : 50 AFG")
			print(f" 1-Month Price : 100 AFG")
			print(50*"-")
			input("[Press Enter To Send Key To Admin]")
			os.system(f"termux-open-url https://t.me/@Black_Ha3k?text={bumper}")
			qsbuy()
